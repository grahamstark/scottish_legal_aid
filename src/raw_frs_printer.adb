...
package body raw_frs_printer is
        ...
        -- function toString( hprice : House_Price_Estimates_Rec ) return String is
        -- begin
                -- return
...
--
--
        -- function toString( takeup : Takeup_Estimates_Rec ) return String is
        -- begin
                -- return
        ...
        function toString (v : Account_Rec) return String is
        ...
        function toString (v : Adult_Rec) return String is
                outs : ustr.Unbounded_String := ustr.To_Unbounded_String ("");
        begin
        ...
        function toString (v : Asset_Rec) return String is
                outs : ustr.Unbounded_String := ustr.To_Unbounded_String ("");
        begin
                ustr.Append (outs, INDENT & "SERNUM = " & String (v.SERNUM) & stda.LF);
                ustr.Append (outs, INDENT & "hh_sequence = " & v.hh_sequence'Img & stda.LF);
        ...
        function toString (v : Benefit_Rec) return String is
                outs : ustr.Unbounded_String := ustr.To_Unbounded_String ("");
        begin
                ustr.Append (outs, INDENT & "SERNUM = " & String (v.SERNUM) & stda.LF);
                ustr.Append (outs, INDENT & "hh_sequence = " & v.hh_sequence'Img & stda.LF);
        ...
        function toString (v : Benunit_Rec) return String is
                outs : ustr.Unbounded_String := ustr.To_Unbounded_String ("");
        begin
                ustr.Append (outs, INDENT & "SERNUM = " & String (v.SERNUM) & stda.LF);
                ustr.Append (outs, INDENT & "hh_sequence = " & v.hh_sequence'Img & stda.LF);
        ...
        function toString (v : Care_Rec) return String is
                outs : ustr.Unbounded_String := ustr.To_Unbounded_String ("");
        begin
                ustr.Append (outs, INDENT & "SERNUM = " & String (v.SERNUM) & stda.LF);
                ustr.Append (outs, INDENT & "hh_sequence = " & v.hh_sequence'Img & stda.LF);
        ...
        function toString (v : Child_Rec) return String is
                outs : ustr.Unbounded_String := ustr.To_Unbounded_String ("");
        begin
                ustr.Append (outs, INDENT & "SERNUM = " & String (v.SERNUM) & stda.LF);
                ustr.Append (outs, INDENT & "hh_sequence = " & v.hh_sequence'Img & stda.LF);
        ...
        function toString (v : Endowment_Rec) return String is
                outs : ustr.Unbounded_String := ustr.To_Unbounded_String ("");
        begin
                ustr.Append (outs, INDENT & "SERNUM = " & String (v.SERNUM) & stda.LF);
                ustr.Append (outs, INDENT & "hh_sequence = " & v.hh_sequence'Img & stda.LF);
        ...
        function toString (v : ExtChild_Rec) return String is
                outs : ustr.Unbounded_String := ustr.To_Unbounded_String ("");
        begin
                ustr.Append (outs, INDENT & "SERNUM = " & String (v.SERNUM) & stda.LF);
                ustr.Append (outs, INDENT & "hh_sequence = " & v.hh_sequence'Img & stda.LF);
        ...
        function toString (v : GovPay_Rec) return String is
                outs : ustr.Unbounded_String := ustr.To_Unbounded_String ("");
        begin
                ustr.Append (outs, INDENT & "SERNUM = " & String (v.SERNUM) & stda.LF);
                ustr.Append (outs, INDENT & "hh_sequence = " & v.hh_sequence'Img & stda.LF);
        ...
        function toString (v : Household_Rec) return String is
                outs : ustr.Unbounded_String := ustr.To_Unbounded_String ("");
        begin
                ustr.Append (outs, INDENT & "SERNUM = " & String (v.SERNUM) & stda.LF);
                ustr.Append (outs, INDENT & "hh_sequence = " & v.hh_sequence'Img & stda.LF);
        ...
        function toString (v : Insurance_Rec) return String is
                outs : ustr.Unbounded_String := ustr.To_Unbounded_String ("");
        begin
                ustr.Append (outs, INDENT & "SERNUM = " & String (v.SERNUM) & stda.LF);
                ustr.Append (outs, INDENT & "hh_sequence = " & v.hh_sequence'Img & stda.LF);
        ...
        function toString (v : Job_Rec) return String is
                outs : ustr.Unbounded_String := ustr.To_Unbounded_String ("");
        begin
                ustr.Append (outs, INDENT & "SERNUM = " & String (v.SERNUM) & stda.LF);
                ustr.Append (outs, INDENT & "hh_sequence = " & v.hh_sequence'Img & stda.LF);
        ...
        function toString (v : Maint_Rec) return String is
                outs : ustr.Unbounded_String := ustr.To_Unbounded_String ("");
        begin
                ustr.Append (outs, INDENT & "SERNUM = " & String (v.SERNUM) & stda.LF);
                ustr.Append (outs, INDENT & "hh_sequence = " & v.hh_sequence'Img & stda.LF);
        ...
        function toString (v : MortCont_Rec) return String is
                outs : ustr.Unbounded_String := ustr.To_Unbounded_String ("");
        begin
                ustr.Append (outs, INDENT & "SERNUM = " & String (v.SERNUM) & stda.LF);
                ustr.Append (outs, INDENT & "hh_sequence = " & v.hh_sequence'Img & stda.LF);
        ...
        function toString (v : Mortgage_Rec) return String is
                outs : ustr.Unbounded_String := ustr.To_Unbounded_String ("");
        begin
                ustr.Append (outs, INDENT & "SERNUM = " & String (v.SERNUM) & stda.LF);
                ustr.Append (outs, INDENT & "hh_sequence = " & v.hh_sequence'Img & stda.LF);
        ...
        function toString (v : OddJob_Rec) return String is
                outs : ustr.Unbounded_String := ustr.To_Unbounded_String ("");
        begin
                ustr.Append (outs, INDENT & "SERNUM = " & String (v.SERNUM) & stda.LF);
                ustr.Append (outs, INDENT & "hh_sequence = " & v.hh_sequence'Img & stda.LF);
        ...
        function toString (v : Owner_Rec) return String is
                outs : ustr.Unbounded_String := ustr.To_Unbounded_String ("");
        begin
                ustr.Append (outs, INDENT & "SERNUM = " & String (v.SERNUM) & stda.LF);
                ustr.Append (outs, INDENT & "hh_sequence = " & v.hh_sequence'Img & stda.LF);
        ...
        function toString (v : RentCont_Rec) return String is
                outs : ustr.Unbounded_String := ustr.To_Unbounded_String ("");
        begin
                ustr.Append (outs, INDENT & "SERNUM = " & String (v.SERNUM) & stda.LF);
                ustr.Append (outs, INDENT & "hh_sequence = " & v.hh_sequence'Img & stda.LF);
        ...
        function toString (v : Renter_Rec) return String is
                outs : ustr.Unbounded_String := ustr.To_Unbounded_String ("");
        begin
                ustr.Append (outs, INDENT & "SERNUM = " & String (v.SERNUM) & stda.LF);
                ustr.Append (outs, INDENT & "hh_sequence = " & v.hh_sequence'Img & stda.LF);
        ...
        function toString (v : Vehicle_Rec) return String is
                outs : ustr.Unbounded_String := ustr.To_Unbounded_String ("");
        begin
                ustr.Append (outs, INDENT & "SERNUM = " & String (v.SERNUM) & stda.LF);
                ustr.Append (outs, INDENT & "hh_sequence = " & v.hh_sequence'Img & stda.LF);
        ...
        function toString (v : PenProv_Rec) return String is
                outs : ustr.Unbounded_String := ustr.To_Unbounded_String ("");
        begin
                ustr.Append (outs, INDENT & "SERNUM = " & String (v.SERNUM) & stda.LF);
                ustr.Append (outs, INDENT & "hh_sequence = " & v.hh_sequence'Img & stda.LF);
        ...
        function toString (v : Pension_Rec) return String is
                outs : ustr.Unbounded_String := ustr.To_Unbounded_String ("");
        begin
                ustr.Append (outs, INDENT & "SERNUM = " & String (v.SERNUM) & stda.LF);
                ustr.Append (outs, INDENT & "hh_sequence = " & v.hh_sequence'Img & stda.LF);
        ...
        function toString( ch : Raw_Child )
        return String is
                outs : ustr.Unbounded_String := ustr.To_Unbounded_String ("");
        begin
                ustr.append( outs, toString( ch.child ));
                return ustr.To_String (outs);
        end toString;

        function toString( bu : Raw_Benefit_Unit ) return String is
                outs : ustr.Unbounded_String := ustr.To_Unbounded_String ("");
        begin
                ustr.append ( outs, " *** BenUnit "  & stda.LF & toString (bu.benUnit) & stda.LF );
                ustr.append ( outs, " *** num adults " & bu.numAdults'Img );
                for i in 1 .. bu.numAdults loop
                        ustr.append ( outs, " *** Adult " &
                                     i'Img & " ********* " & stda.LF & toString (bu.adults(i)) & stda.LF );
                end loop;
                ustr.append ( outs, " *** num cares " & bu.numCares'Img );
                for i in 1 .. bu.numCares loop
                        ustr.append ( outs, " *** Care " &
                                     i'Img & " ********* " & stda.LF & toString (bu.cares(i)) & stda.LF );
                end loop;
                ustr.append ( outs, " *** num ext. children " & bu.numExtChildren'Img );
                for i in 1 .. bu.numExtChildren loop
                        ustr.append ( outs, " *** ExtChild " &
                                     i'Img & " ********* " & stda.LF & toString (bu.extChild(i)) & stda.LF );
                end loop;
                ustr.append ( outs, " *** num children " & bu.num_Children'Img );
                for i in 1 .. bu.num_Children loop
                        ustr.append ( outs, " *** child " &
                                     i'Img & " ********* " & stda.LF & toString (bu.children(i)) & stda.LF );
                end loop;

	        return ustr.To_String (outs);
        end toString;

        function toString (hh : Raw_Household) return String is
                outs : ustr.Unbounded_String := ustr.To_Unbounded_String ("");
        begin
                ustr.append( outs, " Household ********* " & stda.LF & toString(hh.household) & stda.LF & stda.LF );
                ustr.append( outs, " Renter ********* " & stda.LF & toString(hh.renter) & stda.LF & stda.LF );
                ustr.append( outs, " Owner ********* " & stda.LF & toString(hh.owner) & stda.LF & stda.LF );
                for i in 1 .. hh.numMortConts loop
                        ustr.append ( outs, " *** MortCont " &
                                     i'Img & " ********* " & stda.LF & toString (hh.mortCont (i)) & stda.LF );
                end loop;
                for i in 1 .. hh.numMortgages loop
                        ustr.append ( outs, " *** Mortgage " &
                                     i'Img & " ********* " & stda.LF & toString (hh.mortgages (i)) & stda.LF );
                end loop;
                for i in 1 .. hh.numVehicles loop
                        ustr.append ( outs, " *** Vehicles " &
                                     i'Img & " ********* " & stda.LF & toString (hh.vehicles (i)) & stda.LF );
                end loop;
                for i in 1 .. hh.numRentConts loop
                        ustr.append ( outs, " *** RentCont " &
                                     i'Img & " ********* " & stda.LF & toString (hh.rentCont (i)) & stda.LF );
                end loop;
                ustr.append ( outs, " *** Num Benefit Units " & hh.numBenUnits'Img & stda.LF );
                for i in 1 .. hh.numBenUnits loop
                        ustr.append ( outs, " *** RentCont " &
                                     i'Img & " ********* " & stda.LF & toString (hh.benUnits(i)) & stda.LF );
                end loop;
                return ustr.To_String (outs);
        end toString;
