...
with la_parameters; 
package optimal_rate_searcher is
   ...
   NUM_LIMITS : constant integer := 600;
   ...
   procedure generate_searches( sys : la_parameters.Legal_Aid_Sys; control : Control_Record );
   procedure print_searches( file_name : String );
