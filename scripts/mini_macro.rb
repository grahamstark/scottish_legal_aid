...
class MetaData
        ...
        attr_writer :description, :units, :period, :baseYear, :baseMonth, :adjusted, :startYear, :startMonth, :id; 
        attr_reader :description, :units, :period, :baseYear, :baseMonth, :adjusted, :startYear, :startMonth, :id;
...
class MiniMacro
       ...
       def getChangeFromLatest( key, startDate )
        ...
        def getByD( key, date )
                ...
                # puts  "getByD; key=#{key} date #{date} got row #{row} col = #{col}";
        ...
        def setByD( key, date, value )
                ##puts "setByD; adding key #{key}, date #{date}, value #{value} ";
                row = @data[ date ];
                dkey = key.downcase();
                if( row == nil )then
                        @data[ date ] = Array.new;
